...
class ProductsRoutes {
    ...
    routes() {
        ...
        this.router.post("/product/ingredient", [index_1.authenticationJwt.verifyToken, index_1.authenticationJwt.isAdministrator], productsControllers_1.productsController.createIngredientInProduct);
        //Update
        this.router.put("/product/:id", [index_1.authenticationJwt.verifyToken, index_1.authenticationJwt.isAdministrator], productsControllers_1.productsController.updateProduct);
        this.router.put("/product/ingredient/:id", [index_1.authenticationJwt.verifyToken, index_1.authenticationJwt.isAdministrator], productsControllers_1.productsController.updateIngredientInProduct);
        //Delete
        this.router.delete("/product/:id", [index_1.authenticationJwt.verifyToken, index_1.authenticationJwt.isAdministrator], productsControllers_1.productsController.deleteProduct);
        this.router.delete("/product/ingredient/:id", [index_1.authenticationJwt.verifyToken, index_1.authenticationJwt.isAdministrator], productsControllers_1.productsController.deleteIngredientInProduct);
    }
}
