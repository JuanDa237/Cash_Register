...
import { ProductsFormComponent, UtilityChartComponent, IngredientsFormComponent } from '../../components/index';
...
export class ProductsPrincipalFormComponent {
  ...
  public actualizeUtility(): void {
    ...
    this.chartChild.actualizeUtility(this.ingredientsChild.ingredients, this.ingredientsChild.spendingAmount, product.price);
  }
